(function() {
  ...
  Polymer({
    ...
    _updateVisibleChecks(checksRecord, status, showBlockingChecksOnly,
      ...
      //   this.notifyPath(`_visibleChecks.${idx}._showCheckMessage`));
    },
    ...
    _toggleCheckMessage(e) {
      ...
      this._showCheckMessage = {
        ...this._showCheckMessage, 
        [uuid]: !this._showCheckMessage[uuid]
      };
    },
    ...
    _computeShowCheckMessage(check, _showCheckMessage) {
      return _showCheckMessage[check.checker_uuid];
    },

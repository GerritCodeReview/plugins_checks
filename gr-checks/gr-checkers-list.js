...
(function() {
  ...
  Polymer({
    ...
    _computeVisibleCheckers(_startingIndex, _filteredCheckers) {
      ...
      return this._filteredCheckers.slice(this._startingIndex, this._startingIndex + _checkersPerPage);
    },
    ...
    _computeShowNextButton(_startingIndex, _filteredCheckers) {
      ...
      return (_startingIndex + _checkersPerPage < _filteredCheckers.length)
    },
    ...
    _computeShowPrevButton(_startingIndex, _filteredCheckers) {
      ...
      return (_startingIndex >= _checkersPerPage);
    },

    _handleNextClicked() {
      if (this._startingIndex + _checkersPerPage < this._filteredCheckers.length) {
        this._startingIndex += _checkersPerPage;
      }
    },

    _handlePrevClicked() {
      if (this._startingIndex >= _checkersPerPage) {
        this._startingIndex -= _checkersPerPage;
      }
    },

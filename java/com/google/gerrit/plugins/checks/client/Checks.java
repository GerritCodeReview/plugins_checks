...
public class Checks extends AbstractEndpoint {
  ...
  public CheckInfo create(CheckInput input) throws IOException, RestApiException {
    try {
  ...
  public CheckInfo get(String checkerUuid) throws RestApiException, IOException {
    try {
  ...
  public List<CheckInfo> list() throws RestApiException, IOException {
    try {
  ...
  public CheckInfo rerun(String checkerUuid) throws RestApiException, IOException {
    return rerun(checkerUuid, new RerunInput());
  }

  public CheckInfo rerun(String checkerUuid, RerunInput input)
  ...
  public CheckInfo update(CheckInput input) throws IOException, RestApiException {
    try {
      return performCreateOrUpdate(input);
    } catch (Exception e) {

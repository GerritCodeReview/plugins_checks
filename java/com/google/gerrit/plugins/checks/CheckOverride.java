...
/**
 * An override for a check. Overrides influence the submit impact of a check. Checks which are
 * configured as required for submit can be switched to optional via overrides."
 */
@AutoValue

...
public abstract class CheckUpdate {
  ...
  public abstract static class Builder {
    ...
    /**
     * @param started Set the time the check started. Time can be reset to "null" if passed @code
     *     new Timestamp(0)
     */
    public abstract Builder setStarted(Timestamp started);

    /**
     * @param finished Set the time the check finished. Time can be reset to "null" if passed @code
     *     new Timestamp(0)
     */

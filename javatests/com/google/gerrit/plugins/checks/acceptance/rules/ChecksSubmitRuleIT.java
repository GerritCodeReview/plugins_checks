...
public class ChecksSubmitRuleIT extends AbstractCheckersTest {
  ...
  public void setUp() throws Exception {
    ...
    testCheckerUuid =
        checkerOperations
            ...
            .create();
    assertThat(checkerOperations.checker(testCheckerUuid).get().getStatus())
        .isEqualTo(CheckerStatus.ENABLED);
    assertThat(checkerOperations.checker(testCheckerUuid).get().getBlockingConditions())
  ...
  public void nonApplicableCheckerNotBlockingSubmit() throws Exception {
    ...
    assertThat(checkerOperations.checker(testCheckerUuid).get().getRepository())
        .isEqualTo(otherRepo);
  ...
  @Test
  public void disabledCheckerNotBlockingSubmit() throws Exception {
    postCheckResult(testCheckerUuid, CheckState.FAILED);
  ...
  public void enabledCheckerNotBlockingSubmitIfNoBlockingCondition() throws Exception {
    ...
    checkerOperations
        ...
        .update();
    assertThat(checkerOperations.checker(testCheckerUuid).get().getBlockingConditions()).isEmpty();
